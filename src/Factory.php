...
final class Factory
{
    ...
    public static function createRpc(string $address = '127.0.0.1:8080', bool $useChildProcess = false): AdapterInterface
    {
        $process = new Rpc\Rpc($address, $useChildProcess);
        return new Rpc\Adapter($process);
    }
}
